...
<section id="conteudo" class='col-md-10 offset-md-1'>
    <h1 id="dropdownMenuButton" style="margin-bottom: 20px;white-space: normal; text-align: center;">Lista de elementos criados</h1>
    <div class="card-container row px-1 mb-3" style="padding: 0 80px;">
        @foreach($elements as $element)
            @if($element->type[0] != '#')
                <div class="card col-lg-3 col-md-6 col-sm-5 col-12">
